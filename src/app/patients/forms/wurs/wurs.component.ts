...
@Component({
    selector: 'app-wurs',
    templateUrl: './wurs.component.html',
    styleUrls: ['./wurs.component.scss']
})
export class WursComponent implements OnInit {
    ...
    miFormulario = new FormGroup ({
        ...
        q22: new FormControl('', Validators.required),
        q23: new FormControl('', Validators.required),
        q24: new FormControl('', Validators.required),
        q25: new FormControl('', Validators.required),
    });
    formToUpdate: any = {
        idPaciente: 0,
        form: '',
